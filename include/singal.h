 ...
 * ProOS supports all the signals required by POSIX. They are defined below.
...
/* ProOS specific signals. These signals are not used by user processes,
...
#define SIG_MESS        ((__sighandler_t) 4)    /* pass as message (ProOS) */
