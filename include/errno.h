 ...
 * ProOS, where they must be negative. For example, the READ system call is
 ...
 * system and positive outside, the following mechanism is used. All the
 * definitions are the form:
 *
 ...
 * will be defined, setting EPERM to (- 1), whereas when this
