...
_PROTOTYPE( int chown, (const char *_path, _prs_Uid_t _owner, _prs_Gid_t _group) )
...
_PROTOTYPE( int setgid, (_prs_Gid_t _gid) );
_PROTOTYPE( int setpgid, (pid_t _pid, pid_t _pgid) );
_PROTOTYPE( pid_t setsid, (void) );
_PROTOTYPE( int setuid, (_prs_Uid_t _uid) );
...
_PROTOTYPE( int mknod, (const char *_name, _prs_Mode_t _mode, Dev_t _addr) );
_PROTOTYPE( int mknod4, (const char *_name, _prs_Mode_t _mode, Dev_t _addr, long _size) );
