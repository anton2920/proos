...
#define EXTENDED_MEM_END        ((unsigned int) -1)
 ...
 * o The first 1024 bytes of addressable memory contains the BIOS
 *   real-mode interrupt vector table (IVT). The table is used to access BIOS
 *   hardware services in real-mode by loading an interrupt vector and issuing
