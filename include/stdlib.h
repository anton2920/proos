...
#define MB_CUR_MAX      1       /* max value of multibyte character in ProOS */
...
_PROTOTYPE( char *initstate, (unsigned _seed, char *_state, size_t _size) );
...
/* According to POSIX, getopt should be in unistd.h. What do we do with this? */
