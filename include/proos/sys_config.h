 ...
 *===========================================================================*/
#define _PROOS_MACHINE          _MACHINE_IBM_PC
...
#if (_PROOS_MACHINE == _MACHINE_IBM_PC)
#define _PROOS_CHIP             _CHIP_INTEL
#endif

#if ((_PROOS_MACHINE == _MACHINE_ATARI) || (_PROOS_MACHINE == _MACHINE_MACINTOSH))
#define _PROOS_CHIP             _CHIP_M68000
#endif

#if ((_PROOS_MACHINE == _MACHINE_SUN_4) || (_PROOS_MACHINE == _MACHINE_SUN_4_60))
#define _PROOS_CHIP             _CHIP_SPARC
#define _PROOS_FP_FORMAT        _FP_IEEE
#endif

#if ((_PROOS_MACHINE == _MACHINE_ATARI) || (_PROOS_MACHINE == _MACHINE_SUN_4))
#define _ASKDEV                 1       /* ask for boot device */
#define _FASTLOAD               1       /* use multiple block transfers to init ram */
#endif

#ifndef _PROOS_FP_FORMAT
#define _PROOS_FP_FORMAT        _FP_NONE
#endif

#ifndef _PROOS_MACHINE
#error "In <proos/sys_config.h> please define _PROOS_MACHINE"
#endif

#ifndef _PROOS_CHIP
#error "In <proos/sys_config.h> please define _PROOS_MACHINE to have a legal value"
#endif

#if (_PROOS_MACHINE == 0)
#error "_PROOS_MACHINE has incorrect value (0)"
#endif
