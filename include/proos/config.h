...
/* ProOS release and version numbers. */
/* #define VERSION */ /* #defined by Makefile */

/* This file sets configuration parameters for the ProOS kernel, FS, and PM.
...
/* The MACHINE (called _PROOS_MACHINE) setting can be done
 * in <proos/machine.h>.
 */
#include <proos/sys_config.h>

#define MACHINE             _PROOS_MACHINE
...
/* _PROOS_CHIP is defined in sys_config.h. */
#define CHIP                _PROOS_CHIP

/* _PROOS_FP_FORMAT is defined in sys_config.h. */
#define FP_FORMAT           _PROOS_FP_FORMAT
