...
#endif /* _PROOS_CHIP == M68000 */

/* Values for sc_flags. Must agree with <proos/jmp_buf.h>. */
#define SC_SIGCONTEXT       2                   /* nonzero when signal context is included */
#define SC_NOREGLOCALS      4                   /* nonzero when registers are not to be saved and restored */
