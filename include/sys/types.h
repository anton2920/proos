 ...
 * the case. For example, PROOS-ST (68000) has 32-bit pointers and 16-bit
...
/* The following types are needed because ProOS uses K&R style function
 ...
 */
typedef int             Dev_t;
typedef int             _prs_Gid_t;
typedef int             Nlink_t;
typedef int             _prs_Uid_t;
typedef int             U8_t;
...
typedef unsigned int    _prs_Mode_t;
