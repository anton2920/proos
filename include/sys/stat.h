...
/* The ugly casts on only some definitions are to avoid surprising sign
...
/* Function Prototypes. */
_PROTOTYPE( int chmod, (const char *_path, _prs_Mode_t _mode) );
_PROTOTYPE( int fstat, (int _fildes, struct stat *_buf) );
_PROTOTYPE( int mkdir, (const char *_path, _prs_Mode_t _mode) );
_PROTOTYPE( int mkfifo, (const char *_path, _prs_Mode_t _mode) );
_PROTOTYPE( int stat, (const char *_path, struct stat *_buf) );
_PROTOTYPE( mode_t umask, (_prs_Mode_t _cmask) );
