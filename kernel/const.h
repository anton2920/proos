...
#define SETPSW(rp, _new)            /* permits only certain bits to be set */ \
        ((rp)->p_reg.psw = (rp)->p_reg.psw & ~0xCD5 | (_new) & 0xCD5)
 ...
 * namely low mem below 1M, 1M-16M, and mem after 16M.
 */
#define NR_MEMS         8
