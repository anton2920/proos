...
/* Definitions about chars (8 bits in ProOS, and signed). */
...
/* Definitions about shorts (16 bits in ProOS). */
#define SHRT_MAX            0x7FFF          /* maximum value of a short */
#define SHRT_MIN            (-SHRT_MAX-1)   /* minimum value of a short */
...
#define INT_MAX             0x7FFFFFFF      /* maximum value of a 32-bit int */
#define INT_MIN             (-INT_MAX-1)    /* minimum value of a 32-bit int */
#define UINT_MAX            0xFFFFFFFF      /* maximum value of an unsigned 32-bit int */

/*Definitions about longs (32 bits in ProOS). */
#define LONG_MAX            0x7FFFFFFFL     /* maximum value of a long */
#define LONG_MIN            (-LONG_MAX-1)   /* minimum value of a long */
...
#define _POSIX_SSIZE_MAX    32767           /* read() must support  byte reads */

/* Values actually implemented by ProOS (Tables 2-4, 2-5, 2-6, and 2-7). */
...
#define CHILD_MAX           _NO_LIMIT       /* ProOS does not limit children */
